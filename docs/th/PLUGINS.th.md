...
| `audit` | การตรวจสอบ workspace ตามมาตรฐานภายนอกจาก **ISO / IEC / IEEE** (ISO 9001, ISO/IEC 20000-1, ISO/IEC 27001, ISO/IEC 29110, ISO/IEC/IEEE 29148) หรือ audit ที่ operator เขียนเอง (license header, doc parity, secret scan) | `bwoc audit` CLI |
...
ประเภท `audit` เพิ่มเข้ามาใน `BWOC-EPIC-2`; เหตุผล (ทำไมเลือก `audit` ไม่ใช่ `compliance` หรือ `policy`) และโรดแมปมาตรฐานที่เป็นแรงจูงใจ ดู [BWOC-19 design note](../../notes/2026-05-26_iso-compliance-plugins.md) kind นี้ครอบทั้งสามองค์กรมาตรฐาน software engineering — **ISO** (เช่น 9001), ร่วม **ISO/IEC** (27001, 20000-1, 29110), และร่วม **ISO/IEC/IEEE** (29148, requirements engineering) — เพราะ criterion id, ชื่อมาตรฐาน, และ clause เป็นข้อมูลที่ runtime อ่าน ไม่ใช่ข้อจำกัดว่าองค์กรไหนประกาศ
