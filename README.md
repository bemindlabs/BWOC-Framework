...
**Latest release:** [`v2026.9.23-0`](https://github.com/bemindlabs/BWOC-Framework/releases/tag/v2026.9.23-0) (3.7.0) — **pick from a list, plan before acting**: `/mode` and `/model` open pickers (models listed by the backend, LiteLLM included), `plan` mode proposes without acting, and vLLM / LiteLLM sessions compact against the real context window.
