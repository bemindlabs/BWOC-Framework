...
**Latest release:** [`v2026.8.20-2`](https://github.com/bemindlabs/BWOC-Framework/releases/tag/v2026.8.20-2) (2.44.2) — cross-platform binaries (`aarch64` / `x86_64` macOS & Linux, `x86_64` Windows) with SHA-256 checksums; CalVer tag scheme `v<YYYY>.<M>.<D>-<patch>`. See [`CHANGELOG.md`](CHANGELOG.md) for the per-release history and [GitHub Releases](https://github.com/bemindlabs/BWOC-Framework/releases/latest) for binaries.
