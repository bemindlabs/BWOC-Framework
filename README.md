...
**Latest release:** [`v2026.9.26-0`](https://github.com/bemindlabs/BWOC-Framework/releases/tag/v2026.9.26-0) (3.12.0) — **traces you can turn on**: release binaries carry the OpenTelemetry exporter (inert until `OTEL_EXPORTER_OTLP_ENDPOINT` is set), with GenAI-convention span names and the real `gen_ai.provider.name`.
