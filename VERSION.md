...
**Software-Version:** `2.43.0`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.12.2`   *(canonical here — bumped on `.md` edits)*
...
**Last-Updated:** `2026-08-19T09:42:13Z`   *(UTC, ISO 8601 — stamped on every edit)*
