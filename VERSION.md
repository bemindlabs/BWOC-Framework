...
**Software-Version:** `3.9.1`   *(canonical in `Cargo.toml` — bumped on `.rs` / `.toml` edits)*
**Document-Version:** `1.16.1`   *(canonical here — bumped on `.md` edits)*
...
**Latest release:** [`v2026.9.24-2`](https://github.com/bemindlabs/BWOC-Framework/releases/tag/v2026.9.24-2) *(2026-09-24 — **3.9.1** — agents opened with `/agents` answer as themselves: panes run in the agent's directory)*
**Specification:** [`AGENTS.md`](modules/agent-template/AGENTS.md) v3.0
**Last-Updated:** `2026-09-24T15:04:06Z`   *(UTC, ISO 8601 — stamped on every edit)*
