...
Environment flags: `BWOC_TRUST_GATING` (unset = warn-only trust gate, `1` = enforce, `0` = off), `BWOC_SIGNING_MODE`, `BWOC_WARM`, `BWOC_AUTO_CLAIM`, `BWOC_TASK_WAKEUP`, `BWOC_TASK_POLL_SECS`, `BWOC_LANG`.
